...
public enum ErrorConst {
    ...
    WRONG_INPUT_OZN_KEY("Вы неправильно ввели API-key для  Ozon\uD83D\uDE14\n" +
            " Попробуйте, пожалуйста, еще раз так, как показано на картинке"),
    WRONG_INPUT_OZN_ID("Вы неправильно ввели ClientID для  Ozon\uD83D\uDE14\n" +
                                " Попробуйте, пожалуйста, еще раз так, как показано на картинке"),
    WRONG_INPUT_WB_KEY("Вы неправильно ввели API-key для  WB\uD83D\uDE14\n" +
                                " Попробуйте, пожалуйста, еще раз так, как показано на картинке"),
    NO_ANY_CLIENT_INFO("Вы еще не ввели никакие данные ни для Ozon, ни для WB. " +
            "Пожалуйста, введите их перед использованием, иначе мы не сможем сказать вам какую-либо информацию"),
    ...
    WRONG_WB_INFO("Вы неправильно ввели данные для WB или они больше недействительны, " +
            "или у API-key недостаточный уровень прав\uD83E\uDD72"),
    WB_ERROR("Что-то не так с сервисами WB\uD83D\uDE31"),
    ...
    NO_WB_KEY("Вы еще не ввели API-key для WB\uD83D\uDE05"),
    ...
    No_WB_KEY_COMMAND("Чтобы узнать эту информацию, нам нужен API-key для WB");
